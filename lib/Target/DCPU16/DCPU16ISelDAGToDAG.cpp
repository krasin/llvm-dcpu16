...
SDNode *DCPU16DAGToDAGISel::Select(SDNode *Node) {
  ...
  case ISD::ADD:
    if (SDNode *ResNode =
        SelectIndexedBinOp(Node,
                           ...
                           DCPU16::ADD16rm_POST, DCPU16::ADD16rm_POST))
      return ResNode;
  ...
  case ISD::SUB:
    if (SDNode *ResNode =
        SelectIndexedBinOp(Node,
                           Node->getOperand(0), Node->getOperand(1),
                           DCPU16::SUB16rm_POST, DCPU16::SUB16rm_POST))
      return ResNode;
  ...
  case ISD::AND:
    if (SDNode *ResNode =
        SelectIndexedBinOp(Node,
                           Node->getOperand(0), Node->getOperand(1),
                           DCPU16::AND16rm_POST, DCPU16::AND16rm_POST))
      return ResNode;
    else if (SDNode *ResNode =
             SelectIndexedBinOp(Node, Node->getOperand(1), Node->getOperand(0),
                                DCPU16::AND16rm_POST, DCPU16::AND16rm_POST))
  ...
  case ISD::OR:
    if (SDNode *ResNode =
        SelectIndexedBinOp(Node,
                           Node->getOperand(0), Node->getOperand(1),
                           DCPU16::OR16rm_POST, DCPU16::OR16rm_POST))
      return ResNode;
    else if (SDNode *ResNode =
             SelectIndexedBinOp(Node, Node->getOperand(1), Node->getOperand(0),
                                DCPU16::OR16rm_POST, DCPU16::OR16rm_POST))
  ...
  case ISD::XOR:
    if (SDNode *ResNode =
        SelectIndexedBinOp(Node,
                           Node->getOperand(0), Node->getOperand(1),
                           DCPU16::XOR16rm_POST, DCPU16::XOR16rm_POST))
      return ResNode;
    else if (SDNode *ResNode =
             SelectIndexedBinOp(Node, Node->getOperand(1), Node->getOperand(0),
                                DCPU16::XOR16rm_POST, DCPU16::XOR16rm_POST))
